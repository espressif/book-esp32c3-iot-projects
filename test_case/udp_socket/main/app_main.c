...
static const char *TAG = "udp socket";
...
static esp_err_t esp_create_udp_server(void)
{
    char rx_buffer[128];
    char addr_str[32];
...
static esp_err_t esp_create_udp_client(void)
{
    esp_err_t err = ESP_FAIL;
...
#if LIGHT_UDP_CLIENT
    esp_create_udp_client();
#else
    esp_create_udp_server();
#endif
